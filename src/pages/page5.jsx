...
const Page5 = () => {
  return (
    <div className="w-full h-screen bg-white flex flex-col justify-center items-center px-6">
    <p className="uppercase tracking-[0.25em] text-gray-400 text-sm mb-4">What we are working on</p>
